      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl lg:text-xl font-bold tracking-tight mb-6 text-primary">
              Front-end Developer
            </h1>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-muted-foreground text-xs sm:text-base lg:text-lg mb-8 max-w-2xl mx-auto"
          >
